...
class SkillList {
  constructor() {
    this.items = [
      ...
      new Skill("브레이브버드", "비행", 120, 100, 15, 0, true, "atk", null, "자신도 대상에게 준 피해의 ⅓만큼 반동 피해를 받는다.",
        [{name: "반동"}],),  
      
      new Skill("개척하기", "풀", 50, 100, 20, 0, true, "atk", null, "자신의 스피드를 1랭크 올린다.",
        [{ name: "능력치증감", probability: 100, abil: "speed", target: "atk", value: 1 }], ),
      new Skill("객기", "노말", 70, 100, 20, 0, true, "atk", null, "자신이 독, 마비, 화상 상태일 때 기술의 위력이 2배가 된다.",
        [], ),
      new Skill("임시스킬", "노말", 80+'위력', 100+'명중률', 15+'pp', 0+'우선도', true+'접촉여부', "atk"+"물리특수", null, "임시스킬",
        [], ),
       new Skill("웨이브태클", "물", 120, 100, 10, 0, true, "atk", null, "자신도 대상에게 준 피해의 ⅓만큼 반동 피해를 받는다.",
        [{name: "반동"}],),  
      new Skill("하품", "노말", "-", "-", 10, 0, false, "natk", null, "큰 하품으로 졸음을 유도한다. 다음 턴에 상대를 잠듦 상태로 만든다.",
        [{name: "하품"}],),    
    ];
  }
  // ID로 객체 찾기
