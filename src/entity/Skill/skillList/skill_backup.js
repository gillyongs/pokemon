    ...
    this.items = [
     ...
     new Skill("크로스썬더", "전기", 
      ...
      new Skill("사이코팽", "에스퍼", 
        ...
        [{ name: "벽부수기",  }],
      {touch:true, bite:true, wallBreaker: true} ),
      ...
      new Skill("지구던지기", "격투", 
        ...
        [],{noText: true, touch: true}),    
      
      new Skill("어시스트파워", "에스퍼", 
        20, 100, 10, 0,  
        "catk", null, 
        "자신의 능력이 올라가 있는 만큼 위력이 오른다.",
        [],{}),    
      ...
      new Skill("클리어스모그", "독", 
        50, '-', 15, 0,  
        "catk",  null, 
        "특수한 진흙 덩어리를 내던져서 상대의 능력 변화를 원래대로 돌린다.",
        [{name: "능력치초기화"}], {}),
      ...
      new Skill("초승달춤", "에스퍼", 
        "-", "-", 10, 0,  
        "buf", null, 
        "자신은 기절하지만 교대하여 나오는 포켓몬의 상태 이상과 HP, PP 회복한다.",
        [{ name: "초승달춤" }], ),

      new Skill("희망사항", "노말", 
        "-", "-", 10, 0,  
        "buf", null, 
        "다음 턴에 자신 또는 교체한 포켓몬의 HP를 최대 HP의 ½만큼 회복한다.",
        [{ name: "희망사항" }], ),
